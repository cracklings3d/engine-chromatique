...
#else
#define GLM_HAS_STATIC_ASSERT ((GLM_LANG & GLM_LANG_CXX0X_FLAG) && (((GLM_COMPILER & GLM_COMPILER_CUDA)) || \
...
#else
#define GLM_HAS_INITIALIZER_LISTS ((GLM_LANG & GLM_LANG_CXX0X_FLAG) && (((GLM_COMPILER & GLM_COMPILER_VC) && (GLM_COMPILER >= GLM_COMPILER_VC15)) ||       \
...
#else
#define GLM_HAS_UNRESTRICTED_UNIONS (GLM_LANG & GLM_LANG_CXX0X_FLAG) && ((GLM_COMPILER & GLM_COMPILER_VC) ||     \
                                                                         ((GLM_COMPILER & GLM_COMPILER_CUDA)) || \
                                                                         ((GLM_COMPILER & GLM_COMPILER_HIP)))
#endif
...
#else
#define GLM_HAS_DEFAULTED_FUNCTIONS ((GLM_LANG & GLM_LANG_CXX0X_FLAG) && (((GLM_COMPILER & GLM_COMPILER_VC) && (GLM_COMPILER >= GLM_COMPILER_VC12)) || \
...
#else
#define GLM_HAS_RVALUE_REFERENCES ((GLM_LANG & GLM_LANG_CXX0X_FLAG) && (((GLM_COMPILER & GLM_COMPILER_VC)) ||   \
                                                                        ((GLM_COMPILER & GLM_COMPILER_CUDA)) || \
                                                                        ((GLM_COMPILER & GLM_COMPILER_HIP))))
#endif
...
#else
#define GLM_HAS_EXPLICIT_CONVERSION_OPERATORS ((GLM_LANG & GLM_LANG_CXX0X_FLAG) && (((GLM_COMPILER & GLM_COMPILER_INTEL) && (GLM_COMPILER >= GLM_COMPILER_INTEL14)) || \
                                                                                    ((GLM_COMPILER & GLM_COMPILER_VC) && (GLM_COMPILER >= GLM_COMPILER_VC12)) ||       \
                                                                                    ((GLM_COMPILER & GLM_COMPILER_CUDA)) ||                                            \
                                                                                    ((GLM_COMPILER & GLM_COMPILER_HIP))))
#endif
...
#else
#define GLM_HAS_TEMPLATE_ALIASES ((GLM_LANG & GLM_LANG_CXX0X_FLAG) && (((GLM_COMPILER & GLM_COMPILER_INTEL)) ||                                     \
                                                                       ((GLM_COMPILER & GLM_COMPILER_VC) && (GLM_COMPILER >= GLM_COMPILER_VC12)) || \
                                                                       ((GLM_COMPILER & GLM_COMPILER_CUDA)) ||                                      \
                                                                       ((GLM_COMPILER & GLM_COMPILER_HIP))))
#endif
...
#else
#define GLM_HAS_RANGE_FOR ((GLM_LANG & GLM_LANG_CXX0X_FLAG) && (((GLM_COMPILER & GLM_COMPILER_INTEL)) || \
                                                                ((GLM_COMPILER & GLM_COMPILER_VC)) ||    \
                                                                ((GLM_COMPILER & GLM_COMPILER_CUDA)) ||  \
                                                                ((GLM_COMPILER & GLM_COMPILER_HIP))))
#endif
...
#else
#define GLM_HAS_ALIGNOF ((GLM_LANG & GLM_LANG_CXX0X_FLAG) && (((GLM_COMPILER & GLM_COMPILER_INTEL) && (GLM_COMPILER >= GLM_COMPILER_INTEL15)) || \
...
#else
#define GLM_HAS_CONSTEXPR ((GLM_LANG & GLM_LANG_CXX0X_FLAG) && GLM_HAS_INITIALIZER_LISTS && (((GLM_COMPILER & GLM_COMPILER_INTEL) && (GLM_COMPILER >= GLM_COMPILER_INTEL17)) || ((GLM_COMPILER & GLM_COMPILER_VC) && (GLM_COMPILER >= GLM_COMPILER_VC15))))
#endif
...
#else
#define GLM_HAS_ASSIGNABLE ((GLM_LANG & GLM_LANG_CXX0X_FLAG) && (((GLM_COMPILER & GLM_COMPILER_VC) && (GLM_COMPILER >= GLM_COMPILER_VC15)) || \
...
#else
#define GLM_HAS_MAKE_SIGNED ((GLM_LANG & GLM_LANG_CXX0X_FLAG) && (((GLM_COMPILER & GLM_COMPILER_VC) && (GLM_COMPILER >= GLM_COMPILER_VC12)) || \
                                                                  ((GLM_COMPILER & GLM_COMPILER_CUDA)) ||                                      \
                                                                  ((GLM_COMPILER & GLM_COMPILER_HIP))))
#endif
...
#define GLM_HAS_BITSCAN_WINDOWS ((GLM_PLATFORM & GLM_PLATFORM_WINDOWS) && (((GLM_COMPILER & GLM_COMPILER_INTEL)) || \
