 ...
 *  any other thread.
 *
 *  @remark @macos The OS only supports forward-compatible engine profile contexts
 ...
 *
 *  This function returns the address of the specified Vulkan engine or extension
